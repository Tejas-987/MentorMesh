      ...
      <div style={containerStyle}>
        <div>
          ...
          <div style={titleContainerStyle}>
            <h1 style={titleStyle}>MENTOR MESH</h1>
          </div>
          <img src={"/assets/images/2.png"} alt="Below Image" style={imageBelowStyle} />
        </div>
      </div>
      <h2 style={contentTitleStyle}>WHY MENTOR MESH?</h2>
      <div id="why-skill-swap" style={textContainer}>
        <div style={descriptionStyle}>
          At Mentor Mesh, we believe in the power of mutual learning and collaboration. Here's why Mentor Mesh is the
          ...
          Mentor Mesh provides a platform for you to become a mentor yourself. Share your expertise with others, foster a
          ...
          creativity and innovation. Mentor Mesh isn't just about individual growth—it's about collective advancement.
          <br />
          <br />
          <h4 style={{ color: "#028477" }}>➍ Diverse Learning Opportunities:</h4> With Mentor Mesh, the possibilities are
          ...
          <br />
          <br />
          <h4 style={{ color: "#028477" }}>➎ Continuous Growth:</h4> Learning is a lifelong journey, and Mentor Mesh is
